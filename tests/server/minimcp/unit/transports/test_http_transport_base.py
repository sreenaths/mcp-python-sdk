...
from mcp.server.minimcp.transports.http_transport_base import (
    CONTENT_TYPE_JSON,
...
class TestHTTPTransportBase:
    ...
    def test_handle_unsupported_request(self, transport_base: HTTPTransportBase):
    ...
    def test_check_accept_headers_valid(self, transport_base: HTTPTransportBase):
    ...
    def test_check_accept_headers_invalid(self, transport_base: HTTPTransportBase):
    ...
    def test_check_accept_headers_missing(self, transport_base: HTTPTransportBase):
    ...
    def test_check_accept_headers_with_quality_values(self, transport_base: HTTPTransportBase):
    ...
    def test_check_accept_headers_case_insensitive(self, transport_base: HTTPTransportBase):
    ...
    def test_check_content_type_valid(self, transport_base: HTTPTransportBase):
    ...
    def test_check_content_type_invalid(self, transport_base: HTTPTransportBase):
    ...
    def test_check_content_type_missing(self, transport_base: HTTPTransportBase):
    ...
    def test_check_content_type_with_charset(self, transport_base: HTTPTransportBase):
    ...
    def test_check_content_type_case_insensitive(self, transport_base: HTTPTransportBase):
    ...
    def test_validate_protocol_version_valid(self, transport_base: HTTPTransportBase):
    ...
    def test_validate_protocol_version_invalid(self, transport_base: HTTPTransportBase):
    ...
    def test_validate_protocol_version_missing_uses_default(self, transport_base: HTTPTransportBase):
    ...
    def test_validate_protocol_version_initialize_request_skipped(self, transport_base: HTTPTransportBase):
    ...
    def test_validate_protocol_version_malformed_json_ignored(self, transport_base: HTTPTransportBase):
    ...
    def test_validate_protocol_version_case_insensitive_header(self, transport_base: HTTPTransportBase):
    ...
    def test_build_error_result(self, transport_base: HTTPTransportBase):
        ...
        error_response = json.loads(str(result.content))
        assert "error" in error_response
        # The error message includes the exception type prefix
        assert error_message in error_response["error"]["message"]

    def test_build_error_result_with_different_status_codes(self, transport_base: HTTPTransportBase):
    ...
    def test_multiple_needed_content_types(self, transport_base: HTTPTransportBase):
    ...
    def test_partial_needed_content_types(self, transport_base: HTTPTransportBase):
    ...
    def test_empty_accept_header(self, transport_base: HTTPTransportBase):
    ...
    def test_whitespace_in_headers(self, transport_base: HTTPTransportBase):
    ...
    def test_validate_request_body_valid_json_rpc(self, transport_base: HTTPTransportBase):
    ...
    def test_validate_request_body_valid_json_rpc_with_params(self, transport_base: HTTPTransportBase):
    ...
    def test_validate_request_body_valid_notification(self, transport_base: HTTPTransportBase):
    ...
    def test_validate_request_body_invalid_json(self, transport_base: HTTPTransportBase):
    ...
    def test_validate_request_body_empty_json(self, transport_base: HTTPTransportBase):
    ...
    def test_validate_request_body_json_array(self, transport_base: HTTPTransportBase):
        ...
        assert result is not None
        assert result.status_code == HTTPStatus.BAD_REQUEST
        assert "not a dictionary" in str(result.content)

        # Parse the error response to check error code
        error_response = json.loads(str(result.content))
        assert error_response["error"]["code"] == types.PARSE_ERROR

    def test_validate_request_body_json_string(self, transport_base: HTTPTransportBase):
    ...
    def test_validate_request_body_json_number(self, transport_base: HTTPTransportBase):
    ...
    def test_validate_request_body_missing_jsonrpc(self, transport_base: HTTPTransportBase):
        ...
        assert result is not None
        assert result.status_code == HTTPStatus.BAD_REQUEST
        assert "Not a JSON-RPC message" in str(result.content)

        # Parse the error response to check error code
        error_response = json.loads(str(result.content))
        assert error_response["error"]["code"] == types.INVALID_PARAMS

    def test_validate_request_body_wrong_jsonrpc_version(self, transport_base: HTTPTransportBase):
        ...
        assert result is not None
        assert result.status_code == HTTPStatus.BAD_REQUEST
        assert "Not a JSON-RPC 2.0 message" in str(result.content)

        # Parse the error response to check error code
        error_response = json.loads(str(result.content))
        assert error_response["error"]["code"] == types.INVALID_PARAMS

    def test_validate_request_body_null_jsonrpc(self, transport_base: HTTPTransportBase):
    ...
    def test_validate_request_body_empty_object(self, transport_base: HTTPTransportBase):
    ...
    def test_validate_request_body_extra_fields(self, transport_base: HTTPTransportBase):
    ...
    def test_validate_request_body_unicode_content(self, transport_base: HTTPTransportBase):
    ...
    def test_validate_request_body_nested_objects(self, transport_base: HTTPTransportBase):
    ...
    def test_validate_request_body_malformed_json_cases(self, transport_base: HTTPTransportBase):
